...
//
//        String url = "http://localhost:8080/api/v1/binar/list";
//
...
//            }
//            Barang chekIdBarang = barangRepository.getByID(idsupplier);
//            if(templateResponse.chekNull(chekId)){
//                return   templateResponse.templateEror("Id Supplier Not found");
//            }
//
...
//
//            String url = "http://localhost:8080/api/v1/binar/update/"+idsupplier;
//
//            ResponseEntity<Map> result = restTemplateBuilder.build().postForEntity(url, barang, Map.class);
//
...
//
//            String url = "http://localhost:8080/api/v1/binar/delete/"+barang;
//
//            ResponseEntity<Map> result = restTemplateBuilder.build().postForEntity(url, barang, Map.class);
//
...
public class BarangRestTemplateImpl implements BarangRestTemplateService {
    ...
    public Map insert(Barang obj, Long idsupplier) {
        try {
            ...
            String url = "http://localhost:8080/api/v1/binar/barang/save/"+idsupplier;
    ...
    public Map getAll(int size, int page) {
        try {
            ...
            final  String url = "http://localhost:8080/api/v1/binar/barang/list?size={size}&page={page}";
 ...
 */
           ...
           if(templateResponse.chekNull(chekId)){
            ...
            Barang checkIdBarang = barangRepository.getByID(barangReq.getId());
            if(templateResponse.chekNull(checkIdBarang.getId())){
                return templateResponse.templateEror("Id Barang is requiered");
            }

            RestTemplateBuilder restTemplateBuilder = new RestTemplateBuilder();
            String url = "http://localhost:8080/api/v1/binar/barang/update/"+1;
    ...
    public Map delete(Long barang) {
        ...
        try {
            ...
            Long id = 5L;
            RestTemplateBuilder restTemplateBuilder = new RestTemplateBuilder();
            ResponseEntity<Map> exchange = restTemplateBuilder.build().exchange("http://localhost:8080/api/v1/binar/barang/delete/"+id , HttpMethod.DELETE, entity, Map.class);
