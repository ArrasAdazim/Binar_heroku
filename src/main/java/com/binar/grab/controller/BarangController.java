...
public class BarangController {
     ...
     */
        ...
        if (idUser == null) {
            return new ResponseEntity<Map>(templateResponse.templateEror("User id notfound"), HttpStatus.NOT_FOUND);
        }
        if (nama != null && priceMin !=null && priceMax != null ) {
            ...
            list = barangRepository.findByNamaLower("'%" + nama.toLowerCase() + "%'", show_data);
        } else {
